...
for alpha_run = 1:runs
    for gamma_runs = 1:runs
        ...
        % Save Results
        save(['.\Params\LZ_TE_R', num2str(run),'_',num2str(alpha(alpha_run)),'_',num2str(gamma(gamma_runs)), '.mat'],'test_rewards');
        save(['.\Params\LZ_TR_R', num2str(run),'_',num2str(alpha(alpha_run)),'_',num2str(gamma(gamma_runs)), '.mat'],'mean_rewards');
        save(['.\Params\LZ_TE_TS_R', num2str(run),'_',num2str(alpha(alpha_run)),'_',num2str(gamma(gamma_runs)), '.mat'],'test_totalsteps');
