...
%
% support = 0:0.1:1;
% y1 = trimf(support ,[0 .2 .4]);
% y2 = trimf(support ,[.3 .5 .7]);
% y3 = trimf(support ,[.6 .8 1]);
% plot(support,y1)
% hold on
% plot(support,y2)
% plot(support,y3)
% xlabel('trimf, x = [0 20 40], [20 45 70], [50 70 100]')
% ylabel('mu(x)')

% support = 0:0.01:1;
% y1 = trimf(support ,[0 0 .5]);
% y2 = trimf(support ,[.3 .5 .7]);
% y3 = trimf(support ,[.5 1 1]);
% plot(support,y1)
% hold on
% plot(support,y2)
% plot(support,y3)
