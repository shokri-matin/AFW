    ...
    for gamma_runs = 1:runs 
        for lambda_runs = 1:runs
            for threshold_runs = 1:runs
                ...
                % Save Results
                save(['.\Params\AFW_TE_R', num2str(run),'_',num2str(alpha(alpha_run)),'_',num2str(gamma(gamma_runs)),'_',num2str(lambda(lambda_runs)),'_',num2str(threshold(threshold_runs)), '.mat'],'test_rewards');
                save(['.\Params\AFW_TR_R', num2str(run),'_',num2str(alpha(alpha_run)),'_',num2str(gamma(gamma_runs)),'_',num2str(lambda(lambda_runs)),'_',num2str(threshold(threshold_runs)), '.mat'],'mean_rewards');
                save(['.\Params\AFW_TE_TS_R', num2str(run),'_',num2str(alpha(alpha_run)),'_',num2str(gamma(gamma_runs)),'_',num2str(lambda(lambda_runs)),'_',num2str(threshold(threshold_runs)), '.mat'],'test_totalsteps');
